...
membersLinks =
    [
        ...
        },
        {
            ...
            "md": "https://link.medium.com/GQGeHBl6v8"
        },
        {
            "id": "onethree",
            "url": "1-3.jpg",
            ...
            "future": "",
            "learned": "工作失火，有人笑，有人幫忙，資種夥伴會邊笑邊幫忙。這群人很推很奇葩，33 說「我的世界是 0 和 1 組成的！」告訴我們合作需要理解和溝通；Dash 說「閉嘴！快寫！」所以行動勝於一切；吉米（aka 用靈魂換官網的騷年）在深夜叫我想想他，我會比較好過，謝謝，真的好很多……",
        ...
        },
        {
            ...
            "learned": "資種是讓我一直以來創業靈感得以實踐的其中一個因素，看到很多成功模板激勵了我，同時我也交到很多朋友。",
            "facebook": "",
            "email": "",
            "md": ""
        },
        {
            ...
            "future": "我希望我未來從事的職業不僅能滿足我的生理所需，更重要的是能夠滿足我的內心，不僅對自己，也能對他人有所影響，未來多可期，現在說死就太無趣囉。",
            "learned": "資種的一年使我更加了解團隊合作，不僅是人與人之間的相處、共事，更能夠了解自己在資種這小社會中的定位，藉此勾勒自身在社會中的形象一二。此外，課程、專案等也豐富了我的視野，擴展了我的心靈，讓我更加了解這個世界。資種的一年收穫頗豐，而最大的收穫就是身旁這 32 位一起走到最後的夥伴。",
            "facebook": "",
            "email": "",
            "md": ""
        },
        {
            ...
            "future": "",
            "learned": "在資種這段時光認識到不同科系的好夥伴，共同完成了許多充實豐富的專案，一同學習一起成長。在這當中獲得的能力數之不盡，像是表達能力、撰寫訪綱與會議紀錄等，但最重要的是跟大家一起完成的過程。比起一個人走得快，我更喜歡一群人走得遠～",
            "facebook": "",
            "email": "",
            "md": ""
        },
        {
            ...
            "facebook": "",
            "email": "",
            "md": "https://medium.com/@jywulwu.ms05"
        },
        {
            "id": "twothree",
            "url": "2-3.jpg",
            ...
            "future": "",
            "learned": "不敢說一年後的自己找到了人生方向，但透過每次專案所擔任的職務和角色，抑或是學員間的相互回饋，我敢說我更認識了自己！謝謝一年前的我勇敢踏上資種，將會帶著資種人的精神延續我未來的生活！",
        ...
        },
        {
            ...
            "future": "",
            "learned": "TUV 專案第二組、TB 專案舞組、職涯專案的召部團隊和招生團隊的人資組都讓我印象深刻，這一年最大的收穫就是和資種人的回憶，讓我知道分享和回饋是可以很溫暖很透明的，這一年辛苦了，希望大家每年都可以至少約一次種遊，嗨起來！",
        ...
        },
        {
            ...
            "learned": "跟很多不同類型的人合作、更了解自己、遇到很有責任感的人、交到好朋友、還有很多社會支持、學會更審慎評估自身時間、嘗試跳舞、犯錯然後學習做出調整、了解反饋的重要性、了解因果輪迴、業力引爆、學習不要太快將人分類、知道自己要更謙虛還有努力，偷偷地很喜歡這個地方。",
        ...
        },
        {
            ...
            "learned": "我在資種學會用 Adobe illustrator，嘗試將腦袋的畫面具象建構出來，很開心的是除了有美感、對文字及構圖相當敏銳之外，現在我是有實作能力的人。資種需要大量的設計人力維持專案運作，正巧讓我能長期、穩定的練習製圖，更因為了解軟體操作，讓我能聽懂跟給出實務面的回饋。",
            "facebook": "",
            "email": "",
            "md": ""
        },
        {
            ...
            "learned": "這是一個高度屬人的地方。17 屆經歷了許多不可抗力的外在風險，但我很少聽到有誰不喜歡這裡的人，我想這就是資種的魅力吧。即便我們遇到這麼多困難、挫折，偶爾聽到有人想要放棄、離開，但從來沒有人真的離開過，因為我們已經營造出歸屬感了。最重要的回饋、分享不會淪為喊口號，而是希望大家之後依然能回來，延續這樣的精神。",
        ...
        },
        {
            ...
            "future": "想往金融投顧或是管顧產業發展，之後會培養自己更多的程式＆資料分析能力，並結合大學所學的會計金融知識做應用。",
        ...
        },
        {
            ...
            "future": "幸運的話能中大樂透，安養青年、中年和老年。不幸運的話能寫 code 賣肝，在肝壞掉之前，開一間豆花店，安養中年和老年。",
            "learned": "",
        ...
        },
        {
            ...
            "future": "",
            "learned": "「當個 Taker 很簡單，但 Giver 才能不斷地為社會創造價值，推動發生改變。」大愛彥祺這段話。一開始在資種認真有痛苦想退出的念頭，但真的當自己越投入，做的事看起來像付出，卻意想不到地得到更多回饋與收穫。謝謝自己不怕死的當了一次召部，還有所有願意讓我好好認識你的每一個人。",
        ...
        },
        {
            ...
            "future": "",
            "learned": "學到如何做專案管理，如何適當配置有限的時間與資源，與一群人一同達成目標。此外更加深了自身對於產業的認知，雖然還是迷惘，但也更加知道如何積極面對未知。",
        ...
        },
        {
            ...
            "future": "",
            "learned": "在資種的這一年接觸到了很多行銷管理的課程，雖然完全跟我的科系沾不上邊，但也是我當初選擇加入資種的原因。這一年我也認識了來自不同學校和科系的夥伴，而最開心的事莫過於認識大家，也從其他人身上學習到不一樣的做事態度及方式，正所謂「三人行，必有我師焉」。",
        ...
        },
        {
            ...
            "future": "未來希望能在高中（或其它單位）擔任陪伴學生度過三年時光的導師。除了教他們學科之外，也想將我會的各種領域的知識分享給他們，同時也傳遞一些好的價值觀和心態，更重要的是希望能幫助他們更認識自己，更知道未來要往什麼方向走。",
            "learned": "",
            "facebook": "",
            "email": "cychen346@gmail.com",
            "md": ""
        },
        {
            "id": "fivetwo",
            ...
            "future": "",
            "learned": "遇見一群真的很好很好的人們，互相支持彼此完成目標，在一次次的專案中磨練軟實力，也在擔任職涯專案召部的漫長期間，學習如何在疫情和有限的時間、預算和人力下達到預期的成效，也突破自已去做一些不擅長的事情。",
        ...
        },
        {
            ...
            "future": "我要當交易員賺大錢，坑殺散戶，每天泡在鈔票裡面洗澡（喂），其實找份可以溫飽養家的投信投顧研究類工作，幸福地和我的愛人一起生活我就滿足了。",
        ...
        },
        {
            ...
            "future": "",
            "learned": "在資種，學到最多的是與人相處以及處理事情的軟實力，同時，資種培養我們獨立思考、自主學習的能力。在這邊除了學習，也得到許多學長姐的幫助，並認識一群有趣、能互相了解的朋友。大家明明來自不同校系，卻有著深厚的情感，我想這是最難能可貴的。",
        ...
        },
        {
            ...
            "future": "",
            "learned": "資種的結業當然要寫在資種的收穫，寫未來志向太假掰了啦！在資種說真的認識到一群很棒的人，我從來沒有待過一個沒有抱怨的團體（或者只是我不知道），大家的凱瑞能力堪比本身工作能力，大家只要在一起就是在笑，就算遇到再鳥的事都拍拍彼此肩膀熬過去。這大概是我學到最多的，未來面對很多事情，想到這群一直快（開）樂（車）著的朋友，就會安心的繼續奮鬥下去。",
        ...
        },
        {
            ...
            "future": "",
            "learned": "在這一年裡收穫了許多軟硬實力，包括專案管理、溝通技巧、會議記錄、文書處理、行銷技能、繪圖技能等，也認識一群既可以吃喝玩樂，又能聊工作聊夢想、一起成長的夥伴。謝謝在資種認識的每個人，以及遇到的每件事，都讓我成長許多！",
